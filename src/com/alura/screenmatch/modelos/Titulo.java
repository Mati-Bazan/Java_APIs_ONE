...
import com.alura.screenmatch.excepcion.ErrorEnDuracion;
...
public class Titulo implements Comparable<Titulo>{
    ...
    public Titulo(TituloOmdb miTituloOmbd) {
        ...
        if (miTituloOmbd.runtime().contains("N/A")) {
            throw new ErrorEnDuracion("No pude convertir la duracion.");
        }
        this.duracionEnMinutos = Integer.valueOf(
                miTituloOmbd.runtime().substring(0,3).replace(" ",""));
    }
